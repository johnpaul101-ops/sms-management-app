            ...
            <div className="grid grid-cols-[1fr_1fr_3fr_1fr_1fr_3fr_2fr] bg-purple-100 px-5 py-2 items-center text-xs">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <span
                    className={`px-2 py-1 border border-black rounded-md ${tx.smsCode.length > 0 ? "border-green-800" : ""}`}
                  >
                    {tx?.smsCode.length > 0
                      ? "SMS Received"
                      : "Waiting for SMS"}
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    {tx?.smsCode.length > 0 ? (
                      <span
                        className="bg-purple-50 px-2 py-1 rounded-md font-body hover:bg-purple-300 transition duration-200 ease-in-out cursor-pointer"
                        onClick={() => {
